...
#define FFMPEG_CONFIGURATION "--extra-cflags='-I$X264INCLUDE -I$FAACINCLUDE' --extra-ldflags='-L$X264LIB -L$FAACLIB' --disable-iconv --disable-asm --prefix=../thin-ffmpeg/x86_64 --enable-gpl --enable-nonfree --enable-version3 --disable-bzlib --enable-small --disable-encoders --enable-libx264 --enable-libfaac --enable-encoder=libx264 --enable-encoder=libfaac --disable-muxers --enable-muxer=flv --enable-muxer=mov --enable-muxer=ipod --enable-muxer=psp --enable-muxer=mp4 --enable-muxer=avi --disable-decoders --enable-decoder=aac --enable-decoder=aac_latm --enable-decoder=h264 --enable-decoder=mpeg4 --disable-demuxers --enable-demuxer=flv --enable-demuxer=h264 --enable-demuxer=avi --enable-demuxer=mpc --enable-demuxer=mov --disable-parsers --enable-parser=aac --enable-parser=ac3 --enable-parser=h264 --disable-protocols --enable-protocol=file --enable-protocol=rtmp --enable-protocol=rtp --enable-protocol=udp --disable-bsfs --enable-bsf=aac_adtstoasc --enable-bsf=h264_mp4toannexb --disable-filters --disable-devices --disable-debug --disable-ffmpeg --disable-ffprobe --disable-ffplay --disable-ffserver --disable-debug"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2015
#define FFMPEG_DATADIR "../thin-ffmpeg/x86_64/share/ffmpeg"
#define AVCONV_DATADIR "../thin-ffmpeg/x86_64/share/ffmpeg"
